...
async function main() {
  ...
  const servicesData = [
    {
      ...
      shortDescription:
        'Scalable, high-performance web and mobile apps engineered for speed, reliability, and security.',
      content:
        'End-to-end custom software development tailored to your enterprise needs using modern full-stack frameworks and microservices architecture.',
      icon: 'Code',
      features: [
    ...
    },
    {
      ...
      shortDescription:
        'LLM integrations, custom AI agents, document processing, and smart workflow automation.',
      content:
        'Harness cutting-edge artificial intelligence and automation to streamline operations, cut costs, and empower intelligent decision-making.',
      icon: 'BrainCircuit',
      features: [
        'Custom AI Agents',
        'LLM & RAG Solutions',
    ...
    },
    {
      ...
      shortDescription:
        'AWS/GCP infrastructure, Kubernetes orchestration, CI/CD pipelines, and 99.99% uptime optimization.',
      content:
        'Modernize your cloud infrastructure with robust DevOps practices, containerization, auto-scaling, and active multi-region resilience.',
      icon: 'Cloud',
      features: [
    ...
    },
    {
      ...
      shortDescription:
        'Tailored ERP systems, CRM integrations, inventory management, and automated financial tracking.',
      content:
        'Unify your entire enterprise operations into a seamless platform with automated workflows, real-time reporting, and centralized control.',
      icon: 'Cpu',
      features: [
        'Custom ERP & CRM',
  ...
  const solutionsData = [
    {
      ...
      content:
        'AESCION Enterprise Core provides a comprehensive operating system for growing organizations, offering real-time visibility across all operations.',
    ...
    },
    {
      ...
      content:
        'Empower your team with self-learning AI agents built on private neural networks and domain-specific knowledge bases.',
  ...
  // 7. Default Real Blog Posts & Categories
  ...
  const blogsData = [
    {
      ...
      excerpt:
        'How autonomous AI agents powered by large language models are transforming enterprise workflows, from customer support to internal operations and decision-making.',
      content:
        'Autonomous AI agents are transitioning from basic conversational chatbots into context-aware digital workers capable of completing multi-step operational workflows...',
    ...
    },
    {
      ...
      excerpt:
        'A step-by-step guide to breaking down legacy monolithic applications into independently deployable microservices without disrupting active business operations.',
      content:
        'Decomposing a legacy monolith requires incremental domain-driven design, strangler fig patterns, and rigorous database decoupling...',
      readTime: '9 min read',
      isFeatured: false,
      status: 'PUBLISHED',
    ...
    },
    {
      ...
      excerpt:
        'Implementing zero-trust architecture, CSP headers, and OWASP Top 10 mitigations in Next.js and React enterprise deployments.',
      content:
        'Enterprise web security requires proactive defense-in-depth strategies, strict CORS policies, and automated vulnerability scanning...',
      readTime: '8 min read',
      isFeatured: false,
      status: 'PUBLISHED',
